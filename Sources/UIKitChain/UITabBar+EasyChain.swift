...
public extension EasyChain where Base: UITabBar {
    ...
    func barTintColor(_ barTintColor: UIColor?) -> Self {
        return make { $0.barTintColor = barTintColor }
    }

    @available(iOS 10.0, *)
    @discardableResult
    func unselectedItemTintColor(_ unselectedItemTintColor: UIColor?) -> Self {
        return make { $0.unselectedItemTintColor = unselectedItemTintColor }
    }

    @available(iOS, introduced: 5.0, deprecated: 8.0)
    @discardableResult
    func selectedImageTintColor(_ selectedImageTintColor: UIColor?) -> Self {
        return make { $0.selectedImageTintColor = selectedImageTintColor }
    }
    ...
    func selectionIndicatorImage(_ selectionIndicatorImage: UIImage?) -> Self {
        return make { $0.selectionIndicatorImage = selectionIndicatorImage }
    }

    @available(iOS 6.0, *)
    @discardableResult
    func shadowImage(_ shadowImage: UIImage?) -> Self {
        return make { $0.shadowImage = shadowImage }
    }

    @available(iOS 7.0, *)
    @discardableResult
    func itemPositioning(_ itemPositioning: UITabBar.ItemPositioning) -> Self {
        return make { $0.itemPositioning = itemPositioning }
    }

    @available(iOS 7.0, *)
    @discardableResult
    func itemWidth(_ itemWidth: CGFloat) -> Self {
        return make { $0.itemWidth = itemWidth }
    }

    @available(iOS 7.0, *)
    @discardableResult
    func itemSpacing(_ itemSpacing: CGFloat) -> Self {
        return make { $0.itemSpacing = itemSpacing }
    }

    @available(iOS 7.0, *)
    @discardableResult
    func barStyle(_ barStyle: UIBarStyle) -> Self {
        return make { $0.barStyle = barStyle }
    }

    @available(iOS 7.0, *)
    @discardableResult
    func isTranslucent(_ isTranslucent: Bool) -> Self {
        return make { $0.isTranslucent = isTranslucent }
    }
